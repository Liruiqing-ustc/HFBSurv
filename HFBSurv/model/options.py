...
def parse_args():
    ...
    parser.add_argument('--dataroot', default='/media/disk01/liruiqing/Abalation_study/HFBSurv/data/', help="datasets")
    parser.add_argument('--datatype', default='trimodal_data_5folds.pkl', help="datatype")
    parser.add_argument('--model_save', type=str, default='/media/disk01/liruiqing/Abalation_study/HFBSurv/model_save/',help='models are saved here')
    parser.add_argument('--results', type=str, default='/media/disk01/liruiqing/Abalation_study/HFBSurv/results/', help='results are saved here')
    ...
    parser.add_argument('--lr', default=0.00012, type=float, help='5e-4 for Adam | 1e-3 for AdaBound')
